...
namespace GTA
{
    // ObtenÃ§Ã£o segura e isolada do dispositivo Direct3D 9 do RenderWare (0x00C97C28)
    IDirect3DDevice9* GetD3DDevice();

    // ObtenÃ§Ã£o da janela Win32 do GTA San Andreas (0x00C97C1C)
    HWND GetWindowHandle();

    // VerificaÃ§Ã£o de prontidÃ£o do motor grÃ¡fico
    bool IsReady();

    // FunÃ§Ãµes e estruturas nativas do GTA San Andreas 1.0 US
